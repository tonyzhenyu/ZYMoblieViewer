...
#define INCLUDE_UNITY_INPUTS
    ...
    Varyings vert(Attributes input)
    {
        ...
        output.uv = input.uv;
            ...
            output.positionCS = float4(input.uv * 2 -1,0.5,1);
            output.positionCS = float4(output.positionCS.x,-output.positionCS.y,output.positionCS.z,output.positionCS.w);
        #else
            output.positionCS = float4(input.uv,0.5,1);
        #endif
        return output;
    }
