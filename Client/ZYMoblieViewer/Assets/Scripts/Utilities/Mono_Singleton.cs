...
public class Mono_Singleton<T> : MonoBehaviour where T : Component
{
    // 单件子类实例
    private static T _instance;
    //protected DEvent_AutoRelease dEvent_AutoRelease;
    /// <summary>
    ...
    {
        //dEvent_AutoRelease = new DEvent_AutoRelease();
    }
    /// <summary>
    /// 反初始化调用
    /// </summary>
    ...
    {
        //dEvent_AutoRelease.UnInit();
        //dEvent_AutoRelease = null;
    }
};
