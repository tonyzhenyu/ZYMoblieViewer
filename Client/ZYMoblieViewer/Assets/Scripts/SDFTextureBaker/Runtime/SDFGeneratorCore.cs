...
public static class SDFGeneratorCore
{
    ...
    public static Texture2D CreateSDFTex(Texture2D rawTex)
    {
    ...
    static void MarkRawData(ref TexData whiteSideData, ref TexData blackSideData, Texture2D tex, int width, int height)
    {
    ...
    static void ComparePixel(ref TexData data, int x, int y, int offsetX, int offsetY)
    {
    ...
    static void ComparePixels(ref TexData data, int x, int y, int ox0, int oy0, int ox1, int oy1)
    {
        ComparePixel(ref data, x, y, ox0, oy0);
        ComparePixel(ref data, x, y, ox1, oy1);
    }

    static void ComparePixels(ref TexData data, int x, int y, int ox0, int oy0, int ox1, int oy1, int ox2, int oy2)
    {
        ComparePixel(ref data, x, y, ox0, oy0);
        ComparePixel(ref data, x, y, ox1, oy1);
    ...
    static void GenerateSDF(ref TexData whiteSideData, ref TexData blackSideData, int width, int height)
    {
    ...
    static void WriteTex(Texture2D texture, TexData whiteSideDate, TexData blackSideData, int width, int height)
    {
